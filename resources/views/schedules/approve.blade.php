...
@section('content')
	<h1 class="header">Approve Schedules</h1>
	<div class="col">
...
@section('script')
	...
	function view(id) {
		$("#viewSchedule-modal .modal-body .table-responsive").load("/schedule/displayView",{ '_token' : $("[name=_token]").val(), 'schedule_id' : id}, function(){
