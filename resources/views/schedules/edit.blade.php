...
@section('title')
	Edit Schedule - Scheduling System
@endsection
...
<div class="container">
	...
	<h1 class="header">Edit Schedule</h1>
		<div class="card">
			<div class="card-header">
				<h5>Edit schedule for</h5>
			</div>
			...
			<div class="card-block">
					<div class="container">
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<select class="form-control chosen-select-width chosen-select" name="bldgs[]" id="bldgs" size="10" multiple>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<select class="form-control chosen-select-width chosen-select" name="rooms[]" id="rooms" size="10" multiple>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<select class="form-control chosen-select-width chosen-select" name="bldgs_lab[]" id="bldgs_lab" size="10" multiple>
										@foreach ($bldgs as $bldg)
											<option value="{{ $bldg->id }}">{{ $bldg->bldg }}</option>
										@endforeach
									</select>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<select class="form-control chosen-select-width chosen-select" name="rooms_lab[]" id="rooms_lab" size="10" multiple>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$("#submit").click(function(event){
				...
				if ($( "#editSchedule-form" ).valid() && !hasError && !hasRoomError && checkConflict() != 1) {
					formData = $("#editSchedule-form").serializeArray();
					formData.push({name: 'schedule_id', value: schedule_id});
					$.post('/schedule/editSubmit', formData, function(result){
						if(result == 0){
		...
		function getEditForm(){
			...
			if ($("#curricula_id").val() != "" && $("#year").val() != "" && $("#sem").val() != "" && $("#section").val() != "" && $("#size").val() != "") {
				...
				$("#curriculum-form").load('/schedule/getEditForm', formData, function(){
